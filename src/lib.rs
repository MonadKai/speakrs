...
//! exactly when each speaker starts and stops, short clips, interviews with
//! quick back-and-forth, or audio you plan to subtitle or edit. The 2 second
//! modes are usually worth trying for long recordings where speed matters more
//! than exact speaker-change times, such as meetings, lectures, podcasts, or
//! bulk archives.
//!
//! # Benchmarks
//!
